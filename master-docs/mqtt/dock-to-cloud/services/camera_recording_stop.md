# `camera_recording_stop` — stop recording

Cloud command that stops video recording on the selected camera payload.
...
|---|---|---|
| Cloud → Device | `thing/product/{gateway_sn}/services` | `camera_recording_stop` |
| Device → Cloud | `thing/product/{gateway_sn}/services_reply` | `camera_recording_stop` |

# `camera_recording_start` — start recording

Cloud command that starts video recording on the selected camera payload.
...
|---|---|---|
| Cloud → Device | `thing/product/{gateway_sn}/services` | `camera_recording_start` |
| Device → Cloud | `thing/product/{gateway_sn}/services_reply` | `camera_recording_start` |

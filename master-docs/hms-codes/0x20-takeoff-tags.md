# HMS codes — 0x20** (Takeoff tags)

Prefix byte `0x20`. 2 alarm codes.
...
| Alarm ID | Tip |
|---|---|
| `0x20021000` | Takeoff failed. Ensure control sticks are centered (%alarmid) |
| `0x20120B13` | Remove before takeoff |

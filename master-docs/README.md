...
| `device-properties/` | [`README.md`](device-properties/README.md) — master matrix + narrative + Phase 6a dock-gateway entries: [`dock2.md`](device-properties/dock2.md) (48 properties, 3 writable) + [`dock3.md`](device-properties/dock3.md) (49 properties, 3 writable) |

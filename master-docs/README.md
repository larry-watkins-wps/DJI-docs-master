...
| `mqtt/` | [`README.md`](mqtt/README.md) — topic taxonomy, 13-topic list, envelope, per-family payloads + Phase 4a [`dock-to-cloud/`](mqtt/dock-to-cloud/README.md) catalog (5 methods for binding / topology / config) |

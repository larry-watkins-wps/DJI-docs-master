...
| `mqtt/` | [`README.md`](mqtt/README.md) — topic taxonomy, 13-topic list, envelope, per-family payloads + Phase 4a–4d [`dock-to-cloud/`](mqtt/dock-to-cloud/README.md) catalog (77 methods: binding / topology / config + WaylineManagement + Live-Flight-Controls + LiveStream + Media-Management) |

<template>
  <div class="project-wayline-wrapper height-100">
    ...
    <div :style="{ height : height + 'px'}" class="scrollbar">
      <div id="data" class="height-100 uranus-scrollbar" v-if="waylinesData.length !== 0" @scroll="onScroll">
        <div v-for="wayline in waylinesData" :key="wayline.id">
          <div class="wayline-panel" style="padding-top: 5px;" @click="selectRoute(wayline)">
            ...
            <div class="ml10 mt5" style="color: hsla(0,0%,100%,0.65);">
              ...
              <span class="ml5">{{ DEVICE_NAME[wayline.drone_model_key] || wayline.drone_model_key }}</span>
...
import { CameraFilled, EllipsisOutlined, RocketOutlined, SelectOutlined, UserOutlined } from '@ant-design/icons-vue'
...
const waylinesData = ref<WaylineFile[]>([])
...
function getWaylines () {
  ...
  getWaylineFiles(workspaceId, {
    ...
    waylinesData.value = [...waylinesData.value, ...res.data.list]

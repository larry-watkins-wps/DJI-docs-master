...
export const DEVICE_MODEL_KEY = {
  ...
  M4DCamera: `${DOMAIN.PAYLOAD}-${PAYLOAD_TYPE.M4D_CAMERA}-${DEVICE_SUB_TYPE.ZERO}`,
  M4TDCamera: `${DOMAIN.PAYLOAD}-${PAYLOAD_TYPE.M4TD_CAMERA}-${DEVICE_SUB_TYPE.ZERO}`,

  // M4TD机场相机 (使用DOCK_CAMERA类型)
  M4TDDockCamera: `${DOMAIN.PAYLOAD}-165-${DEVICE_SUB_TYPE.ZERO}-7`,
...
export const DEVICE_NAME = {
  ...
  [DEVICE_MODEL_KEY.M4TDDockCamera]: 'M4TD Dock Camera',
